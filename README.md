...
```
## Output
<img width="924" height="231" alt="image" src="https://github.com/user-attachments/assets/39dda597-9c4b-4fb9-96cd-eb7be6a2ab7b" />

## Result
Hence the task to write a Python program that checks whether a given number is a **palindrome** using loops has been done successfully.
